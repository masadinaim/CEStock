                  ...
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-md-offset-2">
                        <form method="POST" action="<?php echo base_url();?>welcome/uploadgambar" enctype="multipart/form-data">
          ...
          <div class="box box-primary" style="margin-top: 10%">
            <div class="box-body">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#blocked" data-toggle="tab">Blocked List</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="box box-primary">
            <div class="tab-content">
              <div class="tab-pane active" id="profile">
                ...
                <form class="form-horizontal" action="<?php echo base_url();?>Welcome/saveuserdata" method="POST">
                <div class="box-body">
              ...
              <div class="tab-pane" id="password">
                ...
                <div class="box-body">
                  <form method="post" action="<?=base_url();?>welcome/save_password">
                    <table class="table borderless">
                      <tr>
                ...
                <div class="box-body">
                  <table class="table borderless">
                    ...
                    <tr>
                      <td>New Password</td>
                      <td>:</td>
                      <td><input type="password" name="npassword" class="form-control"></td>
                    </tr>
                    <tr>
                      <td>Verify Password</td>
                      <td>:</td>
                      <td><input type="password" name="vpassword" class="form-control"></td>
                    </tr> -->
                  </table>
                </div>
              </div>
